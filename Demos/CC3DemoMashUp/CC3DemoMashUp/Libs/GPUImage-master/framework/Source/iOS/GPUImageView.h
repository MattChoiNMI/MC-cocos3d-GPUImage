...
@property(readonly, nonatomic) unsigned int displayRenderbuffer;
@property(readonly, nonatomic) unsigned int displayFramebuffer;

@property(nonatomic) BOOL enabled;

/**
 * Indicates whether retain the render buffer pixal after presentRenderbuffer.
 *
 * avoid get backscreen using glReadPixels();
 */
@property(nonatomic, assign, readwrite) BOOL preserveBackbuffer;
