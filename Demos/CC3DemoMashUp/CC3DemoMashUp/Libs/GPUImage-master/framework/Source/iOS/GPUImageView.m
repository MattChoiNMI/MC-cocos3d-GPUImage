...
@synthesize enabled;
@synthesize displayRenderbuffer = displayRenderbuffer;
@synthesize displayFramebuffer = displayFramebuffer;
@synthesize preserveBackbuffer = preserveBackbuffer;
...
- (void)commonInit;
{
    ...
    eaglLayer.drawableProperties = [NSDictionary dictionaryWithObjectsAndKeys:[NSNumber numberWithBool:preserveBackbuffer], kEAGLDrawablePropertyRetainedBacking, kEAGLColorFormatRGBA8, kEAGLDrawablePropertyColorFormat, nil];
