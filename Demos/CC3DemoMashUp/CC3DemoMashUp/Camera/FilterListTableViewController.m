...
@property (nonatomic,strong) NSArray *availablyFilterList;
@end
...
- (void)viewDidLoad
{
    ...
    self.availablyFilterList = @[[NSNumber numberWithInteger:GPUIMAGE_CONTRAST],
                                 [NSNumber numberWithInteger:GPUIMAGE_BRIGHTNESS],
                                 [NSNumber numberWithInteger:GPUIMAGE_TOON],
                                 [NSNumber numberWithInteger:GPUIMAGE_SKETCH],
                                 [NSNumber numberWithInteger:GPUIMAGE_GAUSSIAN],
                                 [NSNumber numberWithInteger:GPUIMAGE_NO_FILTERS],
                                 ];
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return [self.availablyFilterList count];
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    NSInteger index = [[self.availablyFilterList objectAtIndex:[indexPath row]] integerValue];
	...
	switch (index)
	{
        ...
        default: cell.textLabel.text = @"No Filter"; break;
	}
...
{
    if ([self.delegate respondsToSelector:@selector(filterTypeDidSelected:)]) {
        [self.delegate filterTypeDidSelected:[[self.availablyFilterList objectAtIndex:indexPath.row] integerValue]];
    }
