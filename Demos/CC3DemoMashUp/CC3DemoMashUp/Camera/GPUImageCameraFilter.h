...
@interface GPUImageCameraFilter : NSObject
@property (nonatomic,strong)   GPUImageVideoCamera            *videoCamera;
@property (nonatomic,unsafe_unretained)     GPUImageView                   *cameraView;
@property (nonatomic,readonly) GPUImageOutput<GPUImageInput>  *filter;
@property (nonatomic,readonly) GPUImageShowcaseFilterType     filterType;

@property (nonatomic,strong) UIImage                        *inputImage;

// should call adjustFilterValue when set the action.
